import APPLE_FILL_ACTIVATED from './apple-fill-activated.png';
...
import KAKAO_FILL_ACTIVATED from './kakao-fill-activated.png';
import KAKAO_FILL_INACTIVATED from './kakao-fill-inactivated.png';
...
export default {
  APP_LOGO,
  NAVER,
  NAVER_FILL_ACTIVATED,
  NAVER_FILL_INACTIVATED,
  KAKAO,
  KAKAO_FILL_ACTIVATED,
  KAKAO_FILL_INACTIVATED,
  GOOGLE,
  GOOGLE_FILL_ACTIVATED,
  GOOGLE_FILL_INACTIVATED,
  APPLE,
  APPLE_WHITE,
